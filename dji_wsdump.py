...
class DJIws(object):
    ...
    def encrypt(raw):
        ...
        cipher = AES.new(DJIws.key_in, AES.MODE_CBC, iv)
    ...
    def decrypt(enc):
        ...
        iv = '\x00' * AES.block_size
        cipher = AES.new(DJIws.key_out, AES.MODE_CBC, iv)
        return DJIws._unpad(cipher.decrypt(enc))
...
class InteractiveConsole(RawInput, code.InteractiveConsole):
    ...
    def write(self, data):
        ...
        # sys.stdout.write("\n")
        buf_out = DJIws.decrypt(data)
        sys.stdout.write("\033[34m< " + buf_out + "\033[39m")
        sys.stdout.write("\n> ")
        sys.stdout.flush()
